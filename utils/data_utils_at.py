...
def get_loader_at(args):
    ...
    data_second_dir = args.data_second_dir
    split = "train"
    store_preprocess_inputs_path = model_data_path + split + "/" + data_second_dir + f"/{split}_box_level_ViT_inputs.npy"
    store_preprocess_annotations_path = model_data_path + split + "/" + data_second_dir + f"/{split}_box_level_ViT_annotations.npy"
